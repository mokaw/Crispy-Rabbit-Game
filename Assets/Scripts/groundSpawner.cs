    ...
    public void SpawnGround()
    {
       ...
       GameObject temp = Instantiate(groundPrefab, nextSpawnPos, Quaternion.identity);
        ...
        {   
            ...
            float playerWidth = playerCol.size.x * transform.localScale.x + 10;
            ...
            // spawne neue Brezel, wenn diese weit genug weg ist von der letzten und wenn sie nicht direkt über einem Hinderniss liegt        
            if(posPow.x > (tempPowerUp + playerWidth) && posPow.x != (posObs.x + 5))
                        {
